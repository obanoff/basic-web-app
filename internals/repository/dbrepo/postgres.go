...
func (m *postgresDBRepo) InsertReservation(res models.Reservation) (int, error) {
	// initialize a new context with timeout; if operation takes less than timeout, it must be canceled to release resources
...
// SearchAvailabilityForAllRooms returns a slice or available rooms, if any, for given date range
